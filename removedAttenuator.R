...
modem_transform <- modem %>% group_by(Time) %>% 
  ...
  ungroup()
modem_transform <- modem_transform[,c("Time","Upstream.Power.Level","HoursSinceUnixEpoch","TimePosix","Downstream.Power")]
...
t.test(withAttenuator$Download.Speed..Mbits.s.,withoutAttenuator$Download.Speed..Mbits.s.)
t.test(withAttenuator$Upload.Speed..Mbits.s.,withoutAttenuator$Upload.Speed..Mbits.s.)
t.test(withAttenuator$Ping..ms.,withoutAttenuator$Ping..ms.)
